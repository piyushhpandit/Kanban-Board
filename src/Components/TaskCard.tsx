...
function TaskCard({ task, deleteTask, updateTask }: Props) {
  ...
  if (isDragging) {
    <div
      ...
      className="bg-mainBackgroundColor p-2.5 h-[100px] min-h-[100px] items-center flex
    text-left opacity-30 border-rose-500
    ...
    >
      ...
      {mouseIsOver && (
        <button
          ...
          className="stroke-white absolute right-1 top-1/2 -translate-y-1/2
